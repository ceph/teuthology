    ...
    try:
        ...
        remote.run(
            args=[
                ...
                'http://ceph.com/git/?p=ceph.git;a=blob_plain;f=src/test/filestore/run_seed_to.sh;hb=7fbc1ab69267e6be96665b0d4e277dc4a07f9220',
                run.Raw('&&'),
                'wget','-q', '-Orun_seed_to_range.sh',
                'http://ceph.com/git/?p=ceph.git;a=blob_plain;f=src/test/filestore/run_seed_to_range.sh;hb=7fbc1ab69267e6be96665b0d4e277dc4a07f9220',
                run.Raw('&&'),
