    ...
    try:
        ...
        remote.run(
            args=[
                ...
                'http://ceph.com/git/?p=ceph.git;a=blob_plain;f=src/test/filestore/run_seed_to.sh;hb=emperor',
                run.Raw('&&'),
                'wget','-q', '-Orun_seed_to_range.sh',
                'http://ceph.com/git/?p=ceph.git;a=blob_plain;f=src/test/filestore/run_seed_to_range.sh;hb=emperor',
                run.Raw('&&'),
