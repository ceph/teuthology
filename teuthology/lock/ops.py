...
def lock_many(ctx, num, machine_type, user=None, description=None,
    ...
    if all(_ in downburst_types for _ in machine_types_list):
        ...
        return lock_many_openstack(ctx, num, machine_type,
                                   ...
                                   arch=arch)
    elif any(_ in downburst_types for _ in machine_types_list):
        the_vps = list(_ for _ in machine_types_list
                                        if _ in downburst_types)
        non_vps = list(_ for _ in machine_types_list
                                        if not _ in downburst_types)
