...
from teuthology.exceptions import (CommandCrashedError, CommandFailedError,
                                   ConnectionLostError)
from teuthology.util.compat import stringify, bytify
...
class TestRun(object):
    ...
    def test_capture_stdout(self):
        ...
        assert stringify(proc.stdout.read()) == output
        assert stringify(proc.stdout.getvalue()) == output
    ...
    def test_capture_stderr_newline(self):
        ...
        assert stringify(proc.stderr.read()) == output
        assert stringify(proc.stderr.getvalue()) == output
